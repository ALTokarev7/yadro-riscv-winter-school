...
#define JOIN2(x, y) JOIN2_X(x, y)
	...
	#define vfmacc_vf_f32mN JOIN2(vfmacc_vf_f32m, N)
	#define vfmul_vv_f32mN JOIN2(vfmul_vv_f32m, N)
	#define vse_v_f32mN JOIN2(vse_v_f32m, N)
	#define vlse_v_f32mN JOIN2(vlse_v_f32m, N)
	...
	#define vle_v_f32m1 __riscv_vle32_v_f32m1
